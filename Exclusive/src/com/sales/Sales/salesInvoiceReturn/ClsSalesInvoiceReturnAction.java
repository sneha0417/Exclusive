...
public class ClsSalesInvoiceReturnAction {
	...
	private String txtlocation,lblduedate,txtdelterms,lbldiscount,lblamount,lblvat,lblnetamount;
...
*/
			...
			if(mode.equalsIgnoreCase("A")){
				...
				val=DAO.insert(date,getTxtrefno(),getCmbprice(),getCmbcurr(),getCurrate(),getSalespersonid(),getClientid(), getRrefno(),getCmbreftype(),getTxtpaymentterms(),getTxtdescription(),
						...
						getRefmasterdocno(),getDescPercentage(),payduedate,getLocationid(),getCmbmodeofpay(),getTxtdelterms(),getCmbbilltype());
