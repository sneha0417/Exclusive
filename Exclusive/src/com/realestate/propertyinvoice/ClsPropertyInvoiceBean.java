...
public class ClsPropertyInvoiceBean {


	private String nipurchasedate;
	private String hidnipurchasedate,cmbtype,taxpers;
	...
	private String lblctcperson,lblclientemail,nettaxamount,lblreftype,lblproperty,lblowner,lblfrom,lblto,lblrentsale,lblsalesagent,lbltaxqry,lblttype,lblmgtype;
	private String cmbreftype,hidcmbreftype,owner,property,contractfromdate,contracttodate,rentsalevalue;
	private String manual,brchName;
	...
	//cargo////
	private String lblbranchaddress,lblbranchtel,lblbranchfax,billingname,billingtrn;
