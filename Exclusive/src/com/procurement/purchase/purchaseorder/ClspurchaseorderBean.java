...
public class ClspurchaseorderBean {
	...
	private String  nipurchaseorderdate,hidnipurchaseorderdate,deliverydate,hiddeliverydate,delterms,payterms,purdesc,msg,mode,deleted,formdetailcode,puraccname,reqmasterdocno,refno,reftype,rrefno,reftypeval;
	...
	private int docno,cmbcurr,chkdiscount,accdocno,descgridlenght,serviecGridlength,masterdoc_no,chkdiscountval,puraccid,shipdatagridlenght,shipdocno,header;
