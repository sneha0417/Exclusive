...
public class AssignJobFollowupAction {
	...
	public String printAction1() throws ParseException, SQLException{
		...
		setLblstype(AssignJobFollowupBean.getLblstype());
		setLbldocnno(AssignJobFollowupBean.getLbldocnno());
		setLblschno(AssignJobFollowupBean.getLblschno());
		setLblassngrp(AssignJobFollowupBean.getLblassngrp());
		setLblclientlpo(AssignJobFollowupBean.getLblclientlpo());
		System.out.println("lop"+AssignJobFollowupBean.getLblclientlpo());
		setDescription(AssignJobFollowupBean.getDescription());
		setPaydescription(AssignJobFollowupBean.getPaydescription());
		/*setLblcompaddress(AssignJobFollowupBean.getLblcompaddress());
	...
	*/
	...
	public String printActionAits() throws ParseException, SQLException{
		HttpServletRequest request=ServletActionContext.getRequest();
