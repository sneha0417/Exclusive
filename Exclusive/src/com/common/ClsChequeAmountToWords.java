...
public class ClsChequeAmountToWords {
	...
	String st6[] = { "Hundred", "Thousand", "Million", "Billion"  };
    
	public static void main(String args[]) throws SQLException {
		ClsChequeAmountToWords c = new ClsChequeAmountToWords();
		c.convertChequeAmountToWords("n");
	 }
	...
	public String convertChequeAmountToWords(String n) throws SQLException
	 {
		 String str1="",str2 = "";
	     amt=n;
	     currency();
	     ...
	     if(currencytype.equalsIgnoreCase("1")){
				ForeignChequeNumberToWord f = new ForeignChequeNumberToWord();
	     ...
	     String converted=str1 + str2+ " Only";
	     
		 return converted;
	 }
	
	public class ForeignChequeNumberToWord  
