...
public class ClsModeAction extends ActionSupport{
	...
	public String saveAction() throws ParseException, SQLException{
		...
		if(mode.equalsIgnoreCase("A")){
						...
						int val=modeDAO.insert(getDocno(),ModeDate,getModeid(),mode,session,getFormdetailcode());
						if(val>0){
							setDocno(val);
			...
			ArrayList<String> driverarray= new ArrayList<>();
				...
				int Status=modeDAO.edit(getDocno(),ModeDate,getModeid(),mode,session,getFormdetailcode());
				if(Status>0){
