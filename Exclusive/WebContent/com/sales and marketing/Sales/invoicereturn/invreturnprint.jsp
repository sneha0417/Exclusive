...
<table width="100%"  > 
  ...
  <td width="10%" align="right">Customer</td>
   ...
   <tr>
    ...
    <td align="right" >TRNO</td>
    <td colspan="5" align="left">: <label name="lbltrno" id="lbltrno" ><s:property value="lbltrno"/></label></td>
     </tr>
...
<table style="border-collapse: collapse;" width="100%"  >
 ...
 <tr height="25" style="background-color: #D8D8D8;border-collapse: collapse;">
    ...
    <td align="right" style="border-collapse: collapse;" width="8%"><b>Discount%</b></td>
     <td align="right" style="border-collapse: collapse;" width="8%"><b>Discount</b></td>
     <td align="right" style="border-collapse: collapse;" width="8%"><b>Taxper</b></td>
     <td align="right" style="border-collapse: collapse;" width="8%"><b>TaxAmount</b></td>
...
<%--  <tr >
 ...
 <table width="100%" border="0">
  <tr>
    <td width="48%">&nbsp;</td>
    <td width="40%" align=right>DISCOUNT:</td>
    <td width="12%" align=right> <label name="lbldiscount" id="lbldiscount" ><s:property value="lbldiscount"/></label></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td align=right>AMOUNT:</td>
    <td align=right> <label name="lblamount" id="lblamount" ><s:property value="lblamount"/></label></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td align=right>VAT 5%:</td>
    <td align=right><label name="lblvat" id="lblvat" ><s:property value="lblvat"/></label></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td align=right>NET TOTAL:</td>
    <td align=right><label name="lblnetamount" id="lblnetamount" ><s:property value="lblnetamount"/></label></td>
  </tr>
  <tr>
    <td colspan="2" align=right>ORDER VALUE:&nbsp;<label id="lblordervaluewords"><s:property value="lblordervaluewords"/></label></td>
