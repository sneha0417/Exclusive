...
<body style="font-size:10px; background-color: white;"  bgcolor="white" onload="hidedata()">
...
<table width="100%">
  ...
  <td><jsp:include page="../../../common/printMainHeader1.jsp"></jsp:include></td>
...
<%-- <table width="100%"  > 
 ...
 <table width="100%">
  ...
  <table width="100%" >
  <tr>  <td width="20%" align="left"> ID </td> <td width="80%">:<label id="lblvendoeacc" name="lblvendoeacc"><s:property value="lblvendoeacc"/> </label> </td> </tr>
  <tr>  <td width="20%"  align="left"> Name </td> <td width="80%">:<label id="lblvendoeaccName" name="lblvendoeaccName"><s:property value="lblvendoeaccName"/></label> </td>  </tr>
  <tr>  <td width="20%"  align="left"> TRN NO </td> <td width="80%">:<label id="lblclienttrno" name="lblclienttrno"><s:property value="lblclienttrno"/></label>  </td>  </tr>
  <tr>  <td width="20%"  align="left"> Telephone No </td> <td width="80%">:<label id="lblclienttel" name="lblclienttel"><s:property value="lblclienttel"/></label>  </td>  </tr>
  <tr>  <td width="20%"  align="left"> Mail ID </td> <td width="80%">:<label id="lblclientmail" name="lblclientmail"><s:property value="lblclientmail"/></label>  </td>  </tr>
  <%-- <tr>  <td width="20%" height="20"  align="left"> Address </td>  <td width="80%">:<label id="lblclientaddress" name="lblclientaddress"><s:property value="lblclientaddress"/></label> </td> </tr>
  <tr>  <td width="20%"  align="left"> City,ST ZIP </td> <td width="80%">:<label id="lblclientcity" name="lblclientcity"><s:property value="lblclientcity"/></label>  </td>  </tr>
  <tr>  <td width="20%"  align="left"> Country </td> <td width="80%">:<label id="lblclientcountry" name="lblclientcountry"><s:property value="lblclientcountry"/></label>  </td> </tr> --%>
  ...
  <tr>  <td width="28%"  align="right">Email :</td> <td width="72%"><label id="lblshipemail" name="lblshipemail"><s:property value="lblshipemail"/></label></td>  </tr>
   <tr>  <td width="28%"  align="right">FAX :</td> <td width="72%"><label id="lblshipfax" name="lblshipfax"><s:property value="lblshipfax"/></label></td>  </tr>
    	...
    	<table width="100%" border="0">
    	  <tr>
		    <td width="73%" align="right">Invoice No</td>
		    <td width="27%">: <label id="lblinvno" name="lblinvno"><s:property value="lblinvno"/></label></td>
		  </tr>
		  <tr>
		  ...
		  <tr>
		    <td width="73%" align="right">Do No &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
		    <td width="27%">: <label id="lblrrefno" name="lblrrefno"><s:property value="lblrrefno"/></label></td>
		  </tr>
		  <tr>
		    <td align="right">Do Date &nbsp;&nbsp;</td>
		    <td>: <label id="lbldate" name="lbldate"><s:property value="lbldate"/></label></td>
		  </tr>
		  <tr>
...
<%int i=0; %>
 ...
 <table width="100%" >
    ...
    <tr><td width="90%">&nbsp;</td>
    <td width="10%" align="right"><b>Total :</b></td><td align="right"><label id="lbltotal"><s:property value="lbltotal"/></label></td>
    </tr>
    <tr><td width="90%">&nbsp;</td>
    <td width="10%" align="right"><b>Vat :</b></td><td align="right"><label id="lblvattotal"><s:property value="lblvattotal"/></label></td>
    </tr>
    <tr><td width="90%">&nbsp;</td>
    <td width="10%" align="right"><b>Rounf Of :</b></td><td align="right"><label id="lblroundof"><s:property value="lblroundof"/></label></td>
    </tr>
    <tr><td width="90%">&nbsp;</td>
    <td width="10%" align="right"><b>NetAmount :</b></td><td align="right"><b><label id="lblordervalue"><s:property value="lblordervalue"/></label></b></td>
    </tr>
    <tr>
    <td  align="right" colspan="3"><b>Amount In Words:</b><label id="lblordervaluewords"><s:property value="lblordervaluewords"/></label></td>
    </tr>
 ...
 <table width="100%" >
  ...
  <hr>
<br>
<div id="bottompage" style="padding-left: 50px;">
<table width="100%" >
  <tr>
    <td width="13%">Processed By</td>
    <td width="20%"><%=session.getAttribute("USERNAME")%></td>
