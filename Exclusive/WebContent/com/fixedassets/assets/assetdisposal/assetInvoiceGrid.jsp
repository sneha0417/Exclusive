<%@page import="com.fixedassets.assets.assetdisposal.*" %>
<%ClsAssetDisposalDAO asi=new ClsAssetDisposalDAO(); %>
        ...
        $(document).ready(function () { 	
            ...
            $("#assetInvoiceGrid").jqxGrid(
            {
                ...
                columns: [
							...
							{ text: 'Asset Name', datafield: 'assetname',editable:false, width: '20.5%'},
							{ text: 'Asset No', datafield: 'assetno',editable:false, width: '14.1%',hidden:true},
							{ text: 'Sales Price', datafield: 'salesprice', width: '10.69%',cellsformat:'d2',cellsalign:'right',align:'right',hidden:true},
							...
							{ text: 'Net P /(L)',  datafield:'net_pl',width: '15%',cellclassname:'column' ,editable:false,cellsformat:'d2',cellsalign:'right',align:'right'}
