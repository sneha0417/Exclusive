...
<script type="text/javascript">
		...
		if(temp1=='UCP' || temp1=='UCR'){
			if(temp!='NA'){
				  ...
				  <%-- var dataExcelExport6='<%=DAO.financeExcelExport(branchval, fromDate, toDate, accType, accDocno, dType, docRangeFrom, docRangeTo, amtRangeFrom, amtRangeTo,chk)%>'; --%>
			}
		}
        ...
        $(document).ready(function () { 
            ...
            $('#jqxUnclearedChequeVoucher').on('rowdoubleclick', function (event) {
                ...
                var path1="",detName="";
              	 var url=document.URL;
       	 		 ...
       	 		 var mod="v";
       	 		if(temp1=="UCP"){
       	 		  detName= "Uncleared Cheque Payment";
       	 		window.parent.formName.value="Uncleared Cheque Payment";
       	 		window.parent.formCode.value="UCP";
       	 		 var doc=$('#jqxUnclearedChequeVoucher').jqxGrid('getcellvalue', rowindex1, "doc_no");
       	 		 
       	 		 path1='com/finance/transactions/unclearedchequepayment/saveUnclearedChequePayment?mode=view&txtunclearedchequepaydocno='+doc; 
       	 		}
       	 		
       	 	if(temp1=="UCR"){
     	 		  detName= "Uncleared Cheque Receipt";
     	 		window.parent.formName.value="Uncleared Cheque Receipt";
     	 		window.parent.formCode.value="UCR";
     	 		 var doc=$('#jqxUnclearedChequeVoucher').jqxGrid('getcellvalue', rowindex1, "doc_no");
     	 		 
     	 		 path1='com/finance/transactions/unclearedchequereceipt/saveUnclearedChequeReceipt?mode=view&txtunclearedchequereceiptdocno='+doc; 
     	 		}
