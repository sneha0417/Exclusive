...
<%   String branchval = request.getParameter("branchval")==null?"NA":request.getParameter("branchval").trim();
     ...
     String hidchckopnprint = request.getParameter("hidchckopnprint")==null?"0":request.getParameter("hidchckopnprint").trim();
...
<script type="text/javascript">
      ...
      var temp='<%=branchval%>';
	  	...
	  	if(temp!='NA'){ 
	  		   data='<%=DAO.accountsStatement(branchval, fromDate, toDate, accdocno,check,hidchckopnprint)%>';
