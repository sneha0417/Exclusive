...
$(document).ready(function () {
	  ...
	  $("body").prepend('<div id="overlay" class="ui-widget-overlay" style="z-index: 1; display: none;"></div>');
	     $("body").prepend("<div id='PleaseWait' style='display: none;position:absolute; z-index: 1;top:180px;right:550px;'><img src='../../../../icons/31load.gif'/></div>");
		   ...
		   $("#date").jqxDateTimeInput({ width: '125px', height: '15px',formatString:"HH.MM.yyyy"});
...
x.open("GET","savedata.jsp?docno="+docno+"&branchids="+branchids+"&remarks="+remarks+"&cmbinfo="+cmbinfo+"&folldate="+folldate+"&refno="+refno+"&enqdetdocno="+enqdetdocno,true);
