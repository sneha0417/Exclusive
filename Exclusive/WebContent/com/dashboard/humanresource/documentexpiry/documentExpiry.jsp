    ...
    <div class="master-container">
        ...
        <div class="sidebar-filters">
            <div class="sidebar-scroll-content">
                ...
                <!-- Employee Info Card -->
                <div class="filter-card">
                    <textarea id="empinfo" name="empinfo" readonly="readonly" placeholder="Employee Info..."><s:property value="empinfo"></s:property></textarea>
                </div>
