...
<script type="text/javascript">
    ...
    function funClearInfo(){
		$('#cmbbranch').val('a');$('#cmbyear').val('');$('#cmbempdepartment').val('');$('#cmbempcategory').val('');
		...
		$('#cmbltype').val('');$('#hidempdocno').val('');$('#txtdays').val('');document.getElementById("hidlabel").innerHTML="";        
	}
    
    function funClearYearInfo(){
		$('#cmbempdepartment').val('');$('#cmbempcategory').val('');
		$('#txtemployeeid').val('');$('#txtemployeedocno').val('');$('#txtemployeename').val('');
		$("#leaveDetailsGridID").jqxGrid('clear');$("#leaveDetailsGridID").jqxGrid('addrow', null, {});
		...
		if (x.readyState==4 && x.status==200)
			{
				...
				if(parseInt(items)>0){
					...
					$('#cmbbranch').val('a');$('#cmbltype').val('');$('#hidempdocno').val('');$('#txtdays').val('');     
...
<tr>
    ...
    <tr>
     ...
     <tr>
       ...
       <input type="hidden" id="hidempdocno" name="hidempdocno" value='<s:property value="hidempdocno"/>'/></td>
     </tr> 
     ...
     <td width="100%" colspan="2">   
      <fieldset>
        <legend>Credit Leaves</legend>
      <table  width="100%">
      <tr>
      <td align="center" colspan="2"><label class="branch" id="hidlabel"></label></td>       
     </tr>
      <tr>
      <td align="right"><label class="branch">Leave Type</label></td>   
      <td><select id="cmbltype" name="cmbltype" style="width:80%;" value='<s:property value="cmbltype"/>'>
      <option value="">--Select--</option></select></td>
     </tr>
     <tr>
      <td align="right"><label class="branch">Days</label></td>     
     <td > <input type="text" id="txtdays" name="txtdays" style="width:80%;height:20;" onkeypress="return isNumberKey(event)"  value='<s:property value="txtdays"/>'/></td>
     </tr> 
     <tr><td colspan="2" align="center"><input type="button" class="myButtons" name="update" id="update"  value="Update" onclick="funUpdate();"></td></tr> 
      </table>   
      </fieldset>
     </td>
     </tr>
...
<td width="80%">
	<table width="100%">
		 <tr><td><div id="leaveDetailsDiv"><jsp:include page="leaveDetailsGrid.jsp"></jsp:include></div></td></tr> 
	</table>   
</td></tr></table>
</div>     
