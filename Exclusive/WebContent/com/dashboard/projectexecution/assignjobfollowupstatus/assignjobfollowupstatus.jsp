		   ...
		   var docno1=document.getElementById("docno1").value;
			...
			if($('#statusid').val()== "")
			{
				...
				if (x.readyState==4 && x.status==200)
			      ...
			      x.open("GET","saveSchedule.jsp?groupid="+groupid+"&grpmemberid="+grpmemberid+"&grpempid="+grpempid+"&assignid="+assignid+"&statusid="+statusid+"&trno="+trno+"&srno="+srno+"&clientid="+clientid+"&dtype="+dtype+"&brchid="+brchid+"&desc="+desc+"&pdate="+pdate+"&ptime="+ptime,true);
			     x.send();
...
<body onload="getBranch();fromdatecheck();serviceview();">
