...
function getclinfo(event){
     ...
     function funExportBtn(){
  	  ...
  	  JSONToCSVCon(exceldata,'InvoiceProcessing',true);
	...
	<tr><td colspan="2"></td></tr>
	 ...
	 <div id='invdate' name='invdate' value='<s:property value="invdate"/>'></div>
      ...
      <tr>
	      ...
	      <tr>
	      <td align="right"><label class="branch">Notes</label></td>
	      <td ><input style="height:19px;width:200px" type="text" name="txtnotes" id="txtnotes" value='<s:property value="txtnotes"/>'>
						</td>
	      </tr>     
 <tr>     
