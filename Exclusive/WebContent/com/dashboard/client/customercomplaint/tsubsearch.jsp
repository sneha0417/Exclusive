...
%> 
 ...
 loaddata='<%=DAO.tenantrequest(session,sclname,smob,rno,contact)%>';
					...
					{ text: 'CONTACT', datafield: 'contact', width: '20%' }
				          ...
				          $('#jqxmainsearch').on('rowdoubleclick', function (event) 
				        	  ...
				        	  var rowindex1=event.args.rowindex;
				               ...
				               document.getElementById("cmbtenant").value=$('#jqxmainsearch').jqxGrid('getcellvalue', rowindex1, "refname");
				               document.getElementById("hidcmbtenant").value=$('#jqxmainsearch').jqxGrid('getcellvalue', rowindex1, "cldocno");
