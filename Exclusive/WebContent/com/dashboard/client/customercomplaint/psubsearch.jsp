...
var datamain1= '<%=DAO.propertyrequest(session,docnoss,owner,ptype,datess,aa,descriptions,refnoss) %>'; 
            ...
            $("#searshgrid").jqxGrid(
            {
             ...
             $('#searshgrid').on('rowdoubleclick', function (event) {    
                var rowindex1 = event.args.rowindex;
            	 ...
            	 document.getElementById("cmbproperty").value = $('#searshgrid').jqxGrid('getcellvalue',rowindex1, "name");
            	 document.getElementById("hidcmbproperty").value = $('#searshgrid').jqxGrid('getcellvalue',rowindex1, "voc_no");
