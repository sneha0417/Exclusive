...
<script type="text/javascript">
    ...
    function noOfDays(){
        if($('#cmbchoose').val() == 1){
            ...
            $('#txtnoofdays').val('0');            
            $('#txtnoofdays').attr('type', 'text'); // Reveal if applicable
        } else {
            $('#txtnoofdays').attr('readonly', true);
            $('#txtnoofdays').val('');
            $('#txtnoofdays').attr('type', 'hidden'); // Hide when not applicable
        }
    }
                            ...
                            <td>
                                <div class="type-flex-container">
                                    <select id="cmbchoose" name="cmbchoose" onchange="noOfDays();" value='<s:property value="cmbchoose"/>'>
                                        ...
                                        <option value="1">Custom Days</option> <!-- Option added to support existing logic -->
                                    </select>
