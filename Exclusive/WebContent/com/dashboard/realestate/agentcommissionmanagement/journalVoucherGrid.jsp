...
<%
	...
	String commval = request.getParameter("commval")==null?"0":request.getParameter("commval").trim(); 
	String claimval = request.getParameter("claimval")==null?"0":request.getParameter("claimval").trim(); 
%>
<style>
	.redClass
    {
...
var id='<%=id%>';
if(id=="1"){
	data1='<%=DAO.loadjvGrid(acno, id,commval,claimval)%>';
}     
$(document).ready(function () {     
    ...
    $("#jqxjvGrid").jqxGrid(
	{
        ...
        columns: [
			...
			{ text: 'Account Name', datafield: 'accountname',width: '65.6%' },    	     
