...
<%
	...
	String vocno = request.getParameter("vocno")==null?"0":request.getParameter("vocno").trim();
	String brhid = request.getParameter("brhid")==null?"0":request.getParameter("brhid").trim(); 
	String amount = request.getParameter("amount")==null?"0":request.getParameter("amount").trim(); 
%>
<style>
	.redClass
    {
...
var id='<%=id%>';
if(id=="1"){
	data1='<%=DAO.loadjvGrid( vocno, brhid, amount, id)%>';
}     
