...
String mprowarray=request.getParameter("mprows")==null?"":request.getParameter("mprows");   
...
try{
	//System.out.println("mprowarray=="+mprowarray);
	...
	int trno=dao.insert(cdate,"JVT-25", invno, desc, cmaount, cmaount, journalvouchersarray, session, request);
	trnno=Integer.parseInt(request.getAttribute("tranno").toString());  
	if(trno>0){
		String strsql="update re_mreqmgmt set rmbjvtrno='"+trnno+"' where rowno in("+mprowarray+")";                   	                         
