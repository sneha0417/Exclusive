...
function funExportBtn(){
  	JSONToCSVCon(datamain11, 'Tenancy Contract Closing', true);
...
/*    var fromdates=new Date($('#fromdate').jqxDateTimeInput('getDate'));
    ...
    var fromdate="";
	 ...
	 var aa="yes";
	  ...
	  $("#listdiv").load("mainGrid.jsp?barchval="+barchval+"&prdocno="+prdocno+"&cldocno="+cldocno+"&fromdate="+fromdate+"&todate="+todate+"&statusselect="+statusselect+"&aa="+aa);
...
function funupdate()
{
    ...
    var cldate =  $("#closedate").val();
   
   // alert("cldate=="+cldate)
    
    
    $.messager.confirm('Confirm', 'Do you want to close?', function(r){
		if (r){	 
						 $("#overlay, #PleaseWait").show();
			...
			x.open("GET","savedata.jsp?docno="+docno+"&closedate="+cldate,true);
...
function funchkprintConfig() {
    ...
    x.onreadystatechange = function() {
        if (x.readyState == 4 && x.status == 200) {
            ...
            {
            	//document.getElementById("cldatechk").value="1";
            	 $('#closedate').jqxDateTimeInput({
                     disabled: false
                 });

            } else {
            	//document.getElementById("cldatechk").value="0";
            	 $('#closedate').jqxDateTimeInput({
                     disabled: true
                 });
            }
...
<body onload="getBranch();disitems(0);funchkprintConfig();">
...
<td width="20%" >
  ...
  <%--   	  <tr><td  align="right" ><label class="branch">From</label></td><td align="left"><div id='fromdate' name='fromdate' value='<s:property value="fromdate"/>'></div>
   ...
   <tr><td align="right" ><label class="branch">Tenant</label></td><td><input type="hidden" name="cldocno" id="cldocno" value='<s:property value="cldocno"/>'>
            ...
            <tr><td  align="right" ><label class="branch">Close</label></td><td align="left"><div id='closedate' name='closedate' value='<s:property value="closedate"/>'></div>
                    </td></tr> 
            <tr><td colspan="2">&nbsp;</td></tr> 
             	<tr><td colspan="2">&nbsp;</td></tr> 
    <tr><td  align="center" colspan="2"> 
  
    <input type="Button" name="Update" id="Update" class="myButton" value="Contract Close" onclick="funupdate()"> </td> </tr>
...
<input type="hidden" id="cldatechk" name="cldatechk" value='<s:property value="cldatechk"/>'>
