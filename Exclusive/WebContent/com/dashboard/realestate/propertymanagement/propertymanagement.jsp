...
<html lang="en">
<head>
<title>Property Info Management</title>         
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">   
       <div class="todatepanel custompanel">
        ...
        <div class="primarypanel custompanel" style="margin-left:15px;">          
        	  ...
        	  <button type="button" class="btn btn-default btnStyle" id="btninactive" data-toggle="tooltip" title="Inactive Property" data-placement="bottom"><i class="fa fa-ban " aria-hidden="true"></i></button>    
        </div>    
      <div class="actionpanel custompanel">                                                 
          ...
          <button type="button" class="btn btn-default btnStyle" id="btnownerupdate" data-toggle="modal" data-target="#modalownerupdate" data-tooltip="tooltip" title="Owner Update" data-placement="bottom"><i class="fa fa-user-o " aria-hidden="true"></i></button>
           <button type="button" class="btn btn-default btnStyle" id="btnwarranty"  data-toggle="modal" data-target="#modalwarrantyupdate"  data-tooltip="tooltip" title="Warranty Extend" data-placement="bottom"><i class="fa fa-get-pocket " aria-hidden="true"></i></button>
       ...
       <div class="warningpanel custompanel">                        
        ...
        <!--   <div class="btn-group" role="group">        
          	<button type="button" class="btn btn-default" id="btnMeeting" data-toggle="tooltip" title="Meeting" data-placement="bottom"  data-filtervalue="0" data-datafield="mdate" data-filtertype="datefilter"  data-filtercondition="contains"><i class="fa fa-meetup " aria-hidden="true"></i></button>     
          	<span class="badge badge-notify badge-Meeting"></span>                 
          </div>    
           <div class="btn-group" role="group">        
          	<button type="button" class="btn btn-default" id="btnFollowup" data-toggle="tooltip" title="Followup" data-placement="bottom"  data-filtervalue="0" data-datafield="flwupdate" data-filtertype="datefilter"  data-filtercondition="contains"><i class="fa fa-facebook " aria-hidden="true"></i></button>
          	<span class="badge badge-notify badge-Followup"></span>                            
          </div>   -->                        
        </div>                       
         <!--   <div class="detailpanel custompanel">       
          <button type="button" class="btn btn-default" id="btnpartsdetails" data-toggle="modal" data-target="#modalprocesslog" ><i class="fa fa-list-alt " aria-hidden="true" data-toggle="tooltip" title="Activity Log" data-placement="bottom"></i></button>
          <button type="button" class="btn btn-default" id="btnworks" data-toggle="modal" data-target="#modalactivitydetails" ><i class="fa fa-bar-chart " aria-hidden="true" data-toggle="tooltip" title="Activity Statistics" data-placement="bottom"></i></button>        
          ...
          <button type="button" class="btn btn-default" id="btntelesales" data-toggle="modal" data-target="#modaltelesalesdetails" ><i class="fa fa-bar-chart " aria-hidden="true" data-toggle="tooltip" title="Telesales Statistics" data-placement="bottom"></i></button>
        </div>            
         <div class="detailpanel custompanel">          
        ...
        <div class="otherpanel custompanel">
          ...
          <div class="textpanel custompanel" style="padding-top:0;margin-top:0;padding-bottom:0;margin-bottom:0;top:20px;position:absolute;">        
			...
			<!-- <input type="button" id="btnviewrooms" onclick="LoadRoomsFurniture();" value="View Rooms" class="btn btn-info" style="display:none;height:25px;padding:0 2px 0 2px;font-size: 12px;"> -->
        </div>  
      </div>
    </div>  
    <br/>
          ...
          <div class="modal-body">
            ...
            <div class="container-fluid">      
            	<div class="row rowgap">   
            		...
            		<div class="col-md-8">
            			<select class="cmbpstatus" name="cmbpstatus" id="cmbpstatus" style="width: 100%">   
            	...
            	<div class="row rowgap">   
            		<div class="col-md-4">Managed</div>            
            		<div class="col-md-8">
            			<select class="cmbpmngd" name="cmbpmngd" id="cmbpmngd" style="width: 100%">      
            			<!-- <option value="">select</option> -->
           	...
           	<div class="row rowgap">   	
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="text-align:center;">
						<button type="button" class="btn btn-default btnStyle" id="btnupdates" title="Update" data-placement="bottom" onclick="funpropertystatusupdate();"><i class="fa fa-floppy-o " aria-hidden="true"></i></button>     
					</div>
				</div>
            	</div>     
            </div>                                         
...
<!-- Warranty Extend Modal-->                                                  
    <div id="modalwarrantyupdate" class="modal fade" role="dialog">    
      <div class="modal-dialog  modal-md">
        <div class="modal-content">
          <div class="modal-header modalStyle">   
            <button type="button" class="close" data-dismiss="modal">&times;</button>   
            <h4 class="modal-title" style="text-align:center">Warranty Extend</h4> 
             <p id="clientref1" style="text-align:center;"></p>   
          </div>                             
         <div class="modal-body">
            <p><!-- Some text in the modal. --></p>     
            <div class="container-fluid">      
               <div class="row rowgap">   
            		<div class=" col-md-4  ">Existing Warranty</div>            
            		<div class=" col-md-8  ">            			
	                    <input type="text" name="txtexistwarranty" id="txtexistwarranty" disabled style="width:30%;">                
					</div>                          
            	</div> 
            	<div class="row rowgap">      
            		<div class="  col-md-4  ">Extend Warranty</div>          
            		<div class=" col-md-8  ">
            	...
            	<div class="row rowgap">      
            		<div class=" col-md-4 ">Remarks</div>          
            		<div class="  col-md-8 ">
            				<textarea id="txtwarratyremarks" name="txtwarratyremarks" rows="3" style="width:70%;"></textarea>
					</div>                        
            	</div>
            	<div class="row rowgap">   
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="text-align:center;">
						<button type="button" class="btn btn-default btnStyle" id="btnupdatew" title="Update" data-placement="bottom" onclick="funwarrantyupdate();"><i class="fa fa-floppy-o " aria-hidden="true"></i></button>     
					</div>
				</div>
            	</div>      
            </div>                                            
  ...
  <!-- Owner update Modal-->        
    <div id="modalownerupdate" class="modal fade" role="dialog">          
      <div class="modal-dialog modal-md">
        <div class="modal-content">
          <div class="modal-header modalStyle">
            <button type="button" class="close" data-dismiss="modal">&times;</button>  
            <h4 class="modal-title" style="text-align:center">Owner Change</h4> 
             <p id="clientref1" style="text-align:center;"></p>  
          </div>                             
          <div class="modal-body">
            <p><!-- Some text in the modal. --></p>  
            ...
            <div class="row rowgap">   
            	...
            	<div class="row rowgap">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="text-align:center;">   
						<button type="button" class="btn btn-default btnStyle" id="btnupdateow" title="Update" data-placement="bottom" onclick="funownerupdate();"><i class="fa fa-floppy-o " aria-hidden="true"></i></button>
					</div>
				</div>                   
            	</div>   
            </div>  
...
function LoadRoomsFurniture(){	
    ...
    $('[data-tooltip="tooltip"]').tooltip();
        ...
        $('#btnexcel').click(function(){         
        	...
        	$("#overlay,#PleaseWait").show();
        	var visiblecolumns=["owner_name","accname","omobno","oemail","tenant","tmobno","temail","constdate","conenddate","rentalval","optid","type","unit_type","area"];
        	var cols=$("#pagrid").jqxGrid("columns");
        	for(var j=0;j<cols.records.length;j++){
    			var datafield=cols.records[j].datafield;
        		if($.inArray( datafield, visiblecolumns )!== -1){
        			$('#pagrid').jqxGrid('showcolumn', datafield);
        		}
        		else{
        			$('#pagrid').jqxGrid('hidecolumn', datafield);
        		}
        	}
   ...
   function funload(){      
       ...
       $('#ppdiv').load("propertyGrid.jsp?fromdate="+fromdate+"&todate="+todate+"&id="+1+"&status=1&cmbmanage="+cmbmanage);
   ...
   function funloadinactive(){      
	   ...
	   var todate=$('#todate').jqxDateTimeInput('val');  
	   var cmbmanage=$('#cmbmanage').val();
       $('#ppdiv').load("propertyGrid.jsp?fromdate="+fromdate+"&todate="+todate+"&id="+1+"&status=0&cmbmanage="+cmbmanage);                              
   }
