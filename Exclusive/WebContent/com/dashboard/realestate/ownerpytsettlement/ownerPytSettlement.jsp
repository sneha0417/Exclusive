...
<head>
    ...
    <script type="text/javascript">
        ...
        function funupdate() {
            ...
            x.open("GET", "calculateJv.jsp?docno=" + docno+"&gridarray="+gridarray+"&jvdesc="+jvdesc+"&jvdate="+jvdate, true);
            x.send();        	
        }
                ...
                <tr>
                    <td width="20%">
                        ...
                        <input type="hidden" id="brhid" name="brhid" value='<s:property value="brhid"/>'>
          		        <input type="text" name="hiddescription" id="hiddescription">  
