...
$(document).ready(function () {
    ...
    $("#pagrid").jqxGrid(
    {
        ...
        columns: [   
	           ...
	           { text: 'owneraprvl', datafield: 'owneraprvl' ,hidden:true },   
    ]		 
    });
    $("#overlay, #PleaseWait").hide();
     $('#pagrid').on('rowdoubleclick', function (event) {                           
            ...
            document.getElementById("hidjvtrno").value=$('#pagrid').jqxGrid('getcellvalue', rowindex2, "jvtrno");
            ...
            document.getElementById("hidtentacno").value=$('#pagrid').jqxGrid('getcellvalue', rowindex2, "acno");
            document.getElementById("hidownacno").value=$('#pagrid').jqxGrid('getcellvalue', rowindex2, "accountno");
            document.getElementById("hidownacname").value=$('#pagrid').jqxGrid('getcellvalue', rowindex2, "accountname");
            document.getElementById("hidsupacno").value=$('#pagrid').jqxGrid('getcellvalue', rowindex2, "proacno");
            document.getElementById("hidsupacname").value=$('#pagrid').jqxGrid('getcellvalue', rowindex2, "proname");
            document.getElementById("hidestcost").value=$('#pagrid').jqxGrid('getcellvalue', rowindex2, "estcost");
            document.getElementById("hidmargin").value=$('#pagrid').jqxGrid('getcellvalue', rowindex2, "margin");
            document.getElementById("hidproperty").value=$('#pagrid').jqxGrid('getcellvalue', rowindex2, "property");
            document.getElementById("hidjob").value=$('#pagrid').jqxGrid('getcellvalue', rowindex2, "job");
            document.getElementById("hidmrfacno").value=$('#pagrid').jqxGrid('getcellvalue', rowindex2, "mrfacno");
            document.getElementById("hidposttrno").value=$('#pagrid').jqxGrid('getcellvalue', rowindex2, "posttrno");
            document.getElementById("hidowneracno").value=$('#pagrid').jqxGrid('getcellvalue', rowindex2, "owneracno");
            document.getElementById("hidownername").value=$('#pagrid').jqxGrid('getcellvalue', rowindex2, "owner_name");
