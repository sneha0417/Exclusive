<%@page import="com.dashboard.realestate.propinspanalysis.ClsPropInspAnalysisDAO"%>
<%
...
$(document).ready(function () {  
    ...
    $("#searshgrid").jqxGrid(
    {
        ...
        columns: [ 
			...
			{ text: 'Manage', datafield: 'mgprpty', width: '20%' ,hidden:true},
    ...
    $('#searshgrid').on('rowdoubleclick', function (event) {    
        ...
        document.getElementById("property").value = $('#searshgrid').jqxGrid('getcellvalue',rowindex1, "name");
        document.getElementById("hidproperty").value = $('#searshgrid').jqxGrid('getcellvalue',rowindex1, "doc_no");
