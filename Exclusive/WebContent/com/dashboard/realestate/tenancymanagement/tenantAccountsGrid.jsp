...
<script type="text/javascript">
      ...
      var temp='<%=branchval%>';
	  	...
	  	if(temp!='NA'){ 
	  		   tenantacdata='<%=DAO.accountsStatement(branchval, fromDate, toDate, accdocno,check)%>';
	  	}    
