...
String unitprice=request.getParameter("unitprice")==null?"0":request.getParameter("unitprice").trim();
String total=request.getParameter("total")==null?"0":request.getParameter("total").trim();
String nettotal=request.getParameter("nettotal")==null?"0":request.getParameter("nettotal").trim();
String taxamount=request.getParameter("taxamount")==null?"0":request.getParameter("taxamount").trim();
...
//alert(descdatas);
         ...
         var rendererstring=function (aggregates){
            ...
            $("#nidescdetailsGrid").jqxGrid(
            {
                ...
                columns: [
							...
							{ text: 'Description', datafield: 'description', width: '14%' ,editable: true},
							...
							{ text: 'Net Total', datafield: 'nettotal', width: '6%' ,cellsformat:'d2',cellsalign: 'right', align:'right',aggregates: ['sum'],aggregatesrenderer:rendererstring,editable:false },
							
							
							{ text: 'Tax %', datafield: 'taxper', width: '4%', cellsformat: 'd2', cellsalign: 'right', align: 'right'  ,editable: false},
							...
							{ text: 'Account Name', datafield: 'accname', width: '16%' ,editable: false},
        ...
        /*        alert(event.args.datafield); */
            ...
            $("#nidescdetailsGrid").on('cellvaluechanged', function (event) 
            {
        		...
        		if( document.getElementById("setdocno").value=="1")
        			{
        			return 0;
        			}
    		    var rowBoundIndex = event.args.rowindex;        
			 if(datafield=="account"){
            	   		//  $('#hidaccount').val(event.args.newvalue+"::"+event.args.rowindex);
            	   	  }
