...
%>
       ...
       if(dtype=='GRN' || dtype=='PO')
    	   {
    	   prddata = '<%=purchaseDAO.searchreqProduct(reqmasterdocno,session,dtype,dates,cmbbilltype,accdocno,productname,brandname,gridunit,gridprdname,gridcategory,gridssubcategory,id)%>';   
    	   }
       else
    	   {
    	   prddata= '<%=purchaseDAO.searchProduct(session,dates,cmbbilltype,accdocno,productname,brandname,gridunit,gridprdname,gridcategory,gridssubcategory,id)%>';
    	   }
