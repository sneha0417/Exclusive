  ...
  $(document).ready(function () { 	
	  ...
	  var dataAdapter = new $.jqx.dataAdapter(source);
          ...
          $('#estunitSearch').on('rowdoubleclick', function (event) {
                ...
                $("#jqxEstimation").jqxGrid('setcellvalue', rowindex1, "uom", $('#estunitSearch').jqxGrid('getcellvalue', rowindex2, "unit"));
                $("#jqxEstimation").jqxGrid('setcellvalue', rowindex1, "unitid", $('#estunitSearch').jqxGrid('getcellvalue', rowindex2, "doc_no"));
