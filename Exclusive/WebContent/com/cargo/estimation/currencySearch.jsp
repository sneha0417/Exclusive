  ...
  $(document).ready(function () { 	
	  ...
	  var dataAdapter = new $.jqx.dataAdapter(source);
          ...
          $('#estcurrencySearch').on('rowdoubleclick', function (event) {
                ...
                $('#jqxEstimation').jqxGrid('setcellvalue', rowindex1, "currency" ,$('#estcurrencySearch').jqxGrid('getcellvalue', rowindex2, "currency"));
                $('#jqxEstimation').jqxGrid('setcellvalue', rowindex1, "rate" ,$('#estcurrencySearch').jqxGrid('getcellvalue', rowindex2, "rate"));
                $('#jqxEstimation').jqxGrid('setcellvalue', rowindex1, "curid" ,$('#estcurrencySearch').jqxGrid('getcellvalue', rowindex2, "curid"));
