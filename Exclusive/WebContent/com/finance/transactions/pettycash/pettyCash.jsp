...
<script type="text/javascript">
	$(document).ready(function() {
		 ...
		 $("#jqxPettyCashDate").jqxDateTimeInput({ width: '120px', height: 24, formatString:"dd.MM.yyyy", theme: 'energyblue'});
...
<div class='modern-ui hidden-scrollbar'>
    ...
    <!-- Panel 2: Petty Cash Details -->
    <div class="middle-panel">
        <span class="middle-panel-title">Petty Cash Details</span>
        ...
        <div class="field-row">
            ...
            <div class="input-search-container" style="width: 120px;">
                ...
                <svg class="magnifier-icon" onclick="var d=$('#jqxPettyCashDate').jqxDateTimeInput('getDate'); $('#maindate').jqxDateTimeInput('val', d); accountSearchContent('<%=contextPath%>/com/finance/accountsDetailsSearch.jsp?date='+d); $('#txtforsearch').val(2);" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
            </div>
        ...
        <div class="field-row">
            ...
            <select id="cmbcurrency" name="cmbcurrency" style="width:120px;" value='<s:property value="cmbcurrency"/>' onload="getRatevalue(this.value,$('#jqxPettyCashDate').val());" onchange="getRatevalue(this.value,$('#jqxPettyCashDate').val());">
                <option></option>
            </select>
            ...
            <input type="text" id="txtrate" name="txtrate" style="width:120px; text-align:right;" value='<s:property value="txtrate"/>' onblur="funRoundAmt(this.value,this.id);" tabindex="-1"/>
        </div>
