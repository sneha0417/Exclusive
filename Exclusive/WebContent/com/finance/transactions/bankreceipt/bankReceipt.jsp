	...
	function getDrTotal(){
	  ...
	  function datechange(){
	   ...
	   function funeditstatus() {
           ...
           x.open("GET", "getEditStatus.jsp?masterdoc_no=" + document.getElementById("txttotrno").value, true);  
           x.send();
       }  
</script>
...
<div class='modern-ui hidden-scrollbar'>
        ...
        <div class="middle-panel" style="flex: 1; margin-bottom: 0;">
            ...
            <div class="field-row">
                <label class="lbl-right" style="width:100px; display:flex; align-items:center; justify-content:flex-end; gap:4px;">
                    <input type="checkbox" id="chckpdc" name="chckpdc" onclick="funCheck();funPDCDate($('#hidchckpdc').val(),$('#jqxBankReceiptDate').jqxDateTimeInput('getDate'),$('#jqxChequeDate').jqxDateTimeInput('getDate'));" style="margin:0; width:auto; height:auto !important; cursor:pointer;" /> PDC
                </label>
    ...
    <div class="middle-panel">
        ...
        <div class="field-row" style="margin-top: 15px; justify-content: flex-end; margin-bottom:0;">
            ...
            <input type="text" id="txtapplyinvoiceamt" name="txtapplyinvoiceamt" style="width:100px; text-align:right;" value='<s:property value="txtapplyinvoiceamt"/>' />
    ...
    <div class="middle-panel">
        ...
        <div class="field-row" style="margin-top: 15px; justify-content: flex-end; margin-bottom:0;">
            ...
            <input type="text" id="txtdrtotal" name="txtdrtotal" style="width:100px; text-align:right;" value='<s:property value="txtdrtotal"/>' />
