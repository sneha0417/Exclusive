...
<script type="text/javascript">
	$(document).ready(function() {
		 $("#jqxDebitNoteDate").jqxDateTimeInput({ width: '120px', height: 24, formatString:"dd.MM.yyyy", theme: 'energyblue'});
...
<div class='modern-ui hidden-scrollbar'>
    ...
    <div class="middle-panel">
        ...
        <div class="field-row" style="margin-bottom:0;">
            ...
            <input type="text" id="docno" name="txtdebitnotedocno" value='<s:property value="txtdebitnotedocno"/>' tabindex="-1" style="width:120px;" readonly />
        </div>
    </div>

    <!-- Panel 2: Debit Details -->
    <div class="middle-panel">
        <span class="middle-panel-title">Debit Details</span>
        ...
        <div class="field-row">
            ...
            <div class="input-search-container" style="width: 120px; margin-left: 10px;">
                ...
                <svg class="magnifier-icon" onclick="var d=$('#jqxDebitNoteDate').jqxDateTimeInput('getDate'); $('#maindate').jqxDateTimeInput('val', d); accountSearchContent('<%=contextPath%>/com/finance/clientAccountDetailsSearch.jsp?atype='+$('#cmbtype').val()+'&date='+d); $('#txtforsearch').val(2);" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
            </div>
        ...
        <div class="field-row">
            ...
            <select id="cmbcurrency" name="cmbcurrency" style="width:120px;" value='<s:property value="cmbcurrency"/>' onload="getRatevalue(this.value,$('#jqxDebitNoteDate').val());" onchange="getRatevalue(this.value,$('#jqxDebitNoteDate').val());">
                <option></option>
            </select>
    ...
    <!-- Panel 3: Grid and Totals -->
    <div class="middle-panel">
        <span class="middle-panel-title">Debit Note Allocation</span>
