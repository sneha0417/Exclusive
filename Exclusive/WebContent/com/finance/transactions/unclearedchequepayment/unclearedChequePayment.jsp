...
<script type="text/javascript">
	$(document).ready(function() {
		 ...
		 setTimeout(function () {
		     $("#jqxUnclearedChequePaymentDate, #jqxChequeDate, #maindate").find("input").css({
		         "margin-top": "0px",
		         "line-height": "24px",
                 "font-size": "12px", 
                 "font-family": "Arial, sans-serif", 
		     ...
		     $("#jqxUnclearedChequePaymentDate, #jqxChequeDate, #maindate").find(".jqx-action-button").css({
		         "top": "0px",
		         "height": "24px"
		     });
		 }, 0);
...
<div class='modern-ui hidden-scrollbar'>
        ...
        <div class="middle-panel" style="flex: 1; margin-bottom: 0;">
            ...
            <div class="field-row">
                ...
                <div class="input-search-container" style="width: 120px;">
                    ...
                    <svg class="magnifier-icon" onclick="var d=$('#jqxUnclearedChequePaymentDate').jqxDateTimeInput('getDate'); $('#maindate').jqxDateTimeInput('val', d); accountFromSearchContent('<%=contextPath%>/com/finance/accountsDetailsSearch.jsp?date='+d);" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
                </div>
        ...
        <div class="middle-panel" style="flex: 1; margin-bottom: 0;">
            ...
            <div class="field-row">
                ...
                <div class="input-search-container" style="width: 120px; margin-left: 10px;">
                    ...
                    <svg class="magnifier-icon" onclick="var d=$('#jqxUnclearedChequePaymentDate').jqxDateTimeInput('getDate'); $('#maindate').jqxDateTimeInput('val', d); accountToSearchContent('<%=contextPath%>/com/finance/clientAccountDetailsSearch.jsp?atype='+$('#cmbtotype').val()+'&date='+d);" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
                </div>
    ...
    <div class="middle-panel">
        <span class="middle-panel-title">Uncleared Cheque Allocation</span>
