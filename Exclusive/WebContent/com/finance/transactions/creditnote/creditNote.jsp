...
<div class='modern-ui hidden-scrollbar'>
    ...
    <!-- Panel 2: Credit Details -->
    <div class="middle-panel">
        <span class="middle-panel-title">Credit Details</span>
        ...
        <div class="field-row">
            ...
            <input type="text" id="txtrate" name="txtrate" style="width:120px; text-align:right;" value='<s:property value="txtrate"/>' onblur="funRoundAmt(this.value,this.id);getBaseAmountFrom();getCrTotal();" tabindex="-1"/>
        </div>
    ...
    <div class="middle-panel">
        <span class="middle-panel-title">Credit Note Allocation</span>
