...
<title>GatewayERP(i)</title>
	...
	$(document).ready(function () {
 	...
 	function loadSearch() {
		var chequename=document.getElementById("chequenamess").value;      
	    ...
	    var check = 1;
		getdata(partyname,docNo,date,amount,chequeNo,chequeDt,check,chequename);   
	}
	
 	function getdata(partyname,docNo,date,amount,chequeNo,chequeDt,check,chequename){    
		 $("#refreshdiv").load('bpvMainSearchGrid.jsp?partyname='+partyname.replace(/ /g, "%20")+'&chequename='+chequename.replace(/ /g, "%20")+'&docNo='+docNo+'&date='+date+'&amount='+amount+'&chequeNo='+chequeNo+'&chequeDt='+chequeDt+'&check='+check);
	}
...
<table width="100%">
  ...
  <tr>
    ...
    <td width="14%"><input type="text" name="txtamount" id="txtamount" value='<s:property value="txtamount"/>' style="text-align:right"></td>
   ...
   <tr>
    <td width="6%" align="right">Cheque Name</td>    
    <td colspan="3"><input type="text" name="chequenamess" id="chequenamess" style="width:80%" value='<s:property value="chequenamess"/>'></td>
  </tr>    
  <tr>
