	...
	function funClone(){
	 ...
	 function funFocus()
	  ...
	  /* Validations */
	   ...
	   function getChequeNoAlreadyExists2(chequeno,bankacno,mode,docno){
	  		var x = new XMLHttpRequest();
	  		x.onreadystatechange = function() {
	  			if (x.readyState == 4 && x.status == 200) {
	  				var items = x.responseText.trim();
	  ...
	  function funNotify(){	
		  /* Validation */
		    getChequeNoAlreadyExists2($('#txtchequeno').val(),$('#txtfromdocno').val(),$("#mode").val(),$("#docno").val());
...
<div class='modern-ui hidden-scrollbar'>
    ...
    <div style="display: flex; gap: 15px; margin-bottom: 15px;">
        ...
        <div class="middle-panel" style="flex: 1; margin-bottom: 0;">
            ...
            <div class="field-row">
                <label class="lbl-right" style="width:100px; display:flex; align-items:center; justify-content:flex-end; gap:4px;">
                    <input type="checkbox" id="chckpdc" name="chckpdc" onclick="funCheck();funPDCDate($('#hidchckpdc').val(),$('#jqxBankPaymentDate').jqxDateTimeInput('getDate'),$('#jqxChequeDate').jqxDateTimeInput('getDate'));" style="margin:0; width:auto; height:auto !important; cursor:pointer;" /> PDC
                </label>
    ...
    <div class="middle-panel">
        ...
        <div class="field-row" style="margin-top: 15px; justify-content: flex-end; margin-bottom:0;">
            ...
            <input type="text" id="txtapplyinvoiceamt" name="txtapplyinvoiceamt" style="width:100px; text-align:right;" value='<s:property value="txtapplyinvoiceamt"/>' onblur="funRoundAmt(this.value,this.id);" />
            <input type="hidden" id="txtvalidation" name="txtvalidation" value='<s:property value="txtvalidation"/>' />
            
            <label class="lbl-right" style="width:60px; margin-left:15px;">Applied</label>
            <input type="text" id="txtapplyinvoiceapply" name="txtapplyinvoiceapply" style="width:100px; text-align:right;" value='<s:property value="txtapplyinvoiceapply"/>' onblur="funRoundAmt(this.value,this.id);" tabindex="-1" readonly />
            
            <label class="lbl-right" style="width:60px; margin-left:15px;">Balance</label>
            <input type="text" id="txtapplyinvoicebalance" name="txtapplyinvoicebalance" style="width:100px; text-align:right;" value='<s:property value="txtapplyinvoicebalance"/>' onblur="funRoundAmt(this.value,this.id);" tabindex="-1" readonly />
        </div>
    </div>
    ...
    <div class="middle-panel">
        ...
        <div class="field-row" style="margin-top: 15px; justify-content: flex-end; margin-bottom:0;">
            ...
            <input type="text" id="txtdrtotal" name="txtdrtotal" style="width:100px; text-align:right;" onblur="funRoundAmt(this.value,this.id);" value='<s:property value="txtdrtotal"/>' />
            
            <label class="lbl-right" style="width:60px; margin-left:15px;">Cr. Total</label>
            <input type="text" id="txtcrtotal" name="txtcrtotal" style="width:100px; text-align:right;" onblur="funRoundAmt(this.value,this.id);" value='<s:property value="txtcrtotal"/>' tabindex="-1" readonly />
        </div>
    </div>
