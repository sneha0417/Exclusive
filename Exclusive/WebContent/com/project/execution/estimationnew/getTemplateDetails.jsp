...
<%	
	...
	try{
		...
		while(rs.next()) {
			...
			templatearray.add(rs.getString("desc1").replace( ",", "20%")+" :: "+rs.getString("scope")+" :: "+rs.getString("scopeid")+" :: "+rs.getString("product").replace( ",", "20%")+" :: "+rs.getString("productid")+" :: "+rs.getString("activity")+" :: "+rs.getString("activityid")+" :: "+rs.getString("brandname")+" :: "+rs.getString("unit")+" :: "+rs.getString("scopeamount")+" :: "+rs.getString("amount")+" :: "+rs.getString("total")+" :: "+rs.getString("nettotal")+" :: "+rs.getString("margin")+" :: "+rs.getString("invoiced")+" :: "+rs.getString("proname").replace( ",", "20%")+" :: "+rs.getString("prodoc")+" :: "+rs.getString("unitdocno")+" :: "+rs.getString("psrno")+" :: "+rs.getString("proid")+" :: "+rs.getString("specid")+" :: "+rs.getString("stypeid")+" :: "+rs.getString("site").replace( ",", "20%")+" :: "+rs.getString("sertype")+" :: "+rs.getString("brandid")+" :: "+rs.getString("sitesrno")+" :: "+rs.getString("stdprice")+" :: "+rs.getString("marginper")+" :: "+rs.getString("lbrchg")+" :: "+rs.getString("scopestdcost")+" :: "+rs.getString("qty")+" :: ");
