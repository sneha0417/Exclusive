...
<link href="<%=contextPath%>/css/body.css" media="screen" rel="stylesheet" type="text/css" />
	...
	$(document).ready(function () { 
 	...
 	function loadSearchs1() {  
 		...
 		var accountss=document.getElementById("owner").value;
 		var accnamesss=document.getElementById("pname").value;
 		var datess=document.getElementById("datess11").value;
 
 		var refnoss=document.getElementById("propunitno").value;;
 		
 		
 		var accnamess = accnamesss;
 		var descriptionss=document.getElementById("descriptionss1").value;
...
<table width="100%" >
  <tr >
   ...
   <table width="100%" >
   <tr>
    <td align="right" width="6%">Property ID</td> 
   ...
   <td align="right"  >Unit No</td>
    <td align="left"   ><input type="text" name="propunitno" style="width:100%;" id="propunitno" value='<s:property value="propunitno"/>'></td>
