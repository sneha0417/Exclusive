	...
	$(document).ready(function () { 
	    ...
	    $('#propertysearchwndow').jqxWindow({ width: '50%', height: '60%',  maxHeight: '80%' ,maxWidth: '80%' , title: 'Description Search' ,position: { x: 450, y: 60 }, keyboardCloseKey: 27});
				...
				function getTaxper(date){
				   ...
				   x.send();
					 ...
					 function propertySearchContent(url) {
						 $.get(url).done(function (data) {
							 $('#propertysearchwndow').jqxWindow('open');
							 $('#propertysearchwndow').jqxWindow('setContent', data);
						 }); 
				      } 
						...
						function funNotify(){	
						    ...
						    for(var i = 0;i>=length-1;i++){
									if((rows[i].netottal!="" && rows[i].nettotal!="0.00" && typeof(rows[i].nettotal)!="undefined" && typeof(rows[i].nettotal)!="NaN") && rows[i].account==""){
										val1=1; 
									}
							 }
						    if(val1>0){   
	...
	<table width="100%"     >
	  ...
	  <tr>
	    ...
	    <td align="left" width="15%" > &nbsp;
	    	<input type="text" name="refno" id="refno" style="width:90%;" value='<s:property value="refno"/>' > 
	   	</td>
	    ...
	    <td width="10%">&nbsp;</td>
	  	<td width="20%" align="left" colspan="4"> &nbsp;</td> 
	   
	    <td width="13%" align="right">Doc No </td>
	    <td width="13%"><input type="text" name="docno" id="docno" tabindex="-1" value='<s:property value="docno"/>' readonly="readonly"></td>
	  </tr>
	...
	<!--  <td width="3.1%" align="right">  &nbsp;</td> <td width="3.1%" align="right">  &nbsp;</td> -->
	 <td width="13%">&nbsp;</td>
	  ...
	  <tr>
	    ...
	    <td align="left"width="4%" ><div id="deliverydate" name="deliverydate" value='<s:property value="deliverydate"/>'></div>
