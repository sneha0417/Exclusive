    ...
    $(document).ready(function () { 
	   ...
	   $('#jqxjobSearch').on('rowdoubleclick', function (event) 
		{ 
			...
			$('#jqxRequestGrid').jqxGrid('setcellvalue', rowindex1, "job_docno",$('#jqxjobSearch').jqxGrid('getcellvalue', rowindex2, "doc_no"));				
			$('#jqxRequestGrid').jqxGrid('setcellvalue', rowindex1, "job",$('#jqxjobSearch').jqxGrid('getcellvalue', rowindex2, "job_desc"));		
