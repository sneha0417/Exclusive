        ...
        $(document).ready(function () {  
            ...
            $("#searshgrid").jqxGrid(
            {
                ...
                columns: [
							...
							{ text: 'tdocno', datafield: 'tdoc_no', width: '20%',hidden:true },	
							{ text: 'tenant', datafield: 'tenant', width: '20%',hidden:true },	
						]
            });
        	 ...
        	 document.getElementById("txtpropertydocno").value = $('#searshgrid').jqxGrid('getcellvalue',rowindex1, "doc_no");
        	  ...
        	  document.getElementById("txttenantdocno").value=$('#searshgrid').jqxGrid('getcellvalue', rowindex1, "tdoc_no");
             document.getElementById("txttenant").value=$('#searshgrid').jqxGrid('getcellvalue', rowindex1, "tenant");
