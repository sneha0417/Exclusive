...
<script type="text/javascript">  
	var mdata;		 
	mdata='<%=DAO.requestSearch(session,vocno,id)%>';         
      ...
      $(document).ready(function () {         	                       
          ...
          $("#jqxRequestGrid").jqxGrid(
          {
              ...
              columns: [
					...
					{ text: 'job', datafield: 'job', width: '25%', editable: false },		
					{ text: 'job_docno', datafield: 'job_docno', width: '10%',hidden:true },     
					{text: 'Provider Acc.No',datafield:'vendor_acno',width:'8%', editable: false},
					{ text: 'Provider Name', datafield: 'vendor_name', width: '25%', editable: true },
					{ text: 'vendor_docno', datafield: 'vendor_docno', width: '10%',hidden:true }, 
					{ text: 'Priority', datafield: 'priority', width:'5%',editable: true,columntype:'dropdownlist',
					...
					{ text: 'Estimated Cost', datafield: 'est_cost', width: '10%', editable: true,validation: function (cell, value) {
                      	if (value >0) {
                            return { result: true, message: "Enter Numbers Only" };
                        	}
                        	return false;
     						} },		
					{ text: 'Notify Owner', datafield: 'notify_owner', width:'5%',columntype:'checkbox', 				                
					},
