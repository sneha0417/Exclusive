        ...
        $(document).ready(function () { 
            ...
            $("#jqxAccountsSearch").jqxGrid(
            {
                ...
                columns: [
							...
							{ text: 'Billing Name', datafield: 'billingname', width: '80%' , hidden : true},
							{ text: 'Billing TRN', datafield: 'billingtrn', width: '80%' , hidden : true},
							{ text: 'nontax', datafield: 'nontax', width: '20%' , hidden : true},
							{ text: 'Ac Type', datafield: 'atype', width: '20%' , hidden : true},
             ...
             $('#jqxAccountsSearch').on('rowdoubleclick', function (event) {
               ...
               // document.getElementById("txtfromdocno").value = $('#jqxAccountsSearch').jqxGrid('getcellvalue', rowindex1, "doc_no");
                 ...
                 document.getElementById("acctype").value = $('#jqxAccountsSearch').jqxGrid('getcellvalue', rowindex1, "atype");
            	 ...
            	 document.getElementById("billingname").value = $('#jqxAccountsSearch').jqxGrid('getcellvalue', rowindex1, "billingname");
            	 document.getElementById("billingtrn").value = $('#jqxAccountsSearch').jqxGrid('getcellvalue', rowindex1, "billingtrn");
