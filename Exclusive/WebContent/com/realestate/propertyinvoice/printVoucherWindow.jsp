...
<script type="text/javascript">
 	...
 	function printnologo(){
 		if (($("#mode").val() == "view") && $("#masterdoc_no").val()!="") {
			...
			var dtype=$('#formdetailcode').val();
			var brhid=$("#brchName").val();
			var win= window.open(reurl[0]+"printPropertyInvoice?docno="+document.getElementById("masterdoc_no").value+"&brhid="+brhid+"&dtype="+dtype+"&header=0","_blank","top=250,left=310,Width=800,Height=800,location=no,scrollbars=yes,toolbar=yes");
			win.focus();
		} 
		else {
			$.messager.alert('Message','Select a Document....!','warning');
