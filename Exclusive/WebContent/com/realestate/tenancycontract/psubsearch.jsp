...
$(document).ready(function () {  
    ...
    $('#searshgrid').on('rowdoubleclick', function (event) {    
        ...
        document.getElementById("txtproperty").value = $('#searshgrid').jqxGrid('getcellvalue',rowindex1, "name");
        document.getElementById("txtpropertydocno").value = $('#searshgrid').jqxGrid('getcellvalue',rowindex1, "doc_no");
 		var mngp=$('#searshgrid').jqxGrid('getcellvalue',rowindex1, "mngperc");
       	$('#mgmtfeepercent').val($('#searshgrid').jqxGrid('getcellvalue',rowindex1, "mgmtfeepercent"));
        $('#mgmtfeevalue').val($('#searshgrid').jqxGrid('getcellvalue',rowindex1, "mgmtfeevalue"));
        ...
        $('#chktenancychequeowner').val($('#searshgrid').jqxGrid('getcellvalue',rowindex1, "chktenancychequeowner"));
        
       	var str='';
        $('#propertydetail').empty();
        $('#lblmanage').text($('#searshgrid').jqxGrid('getcellvalue', rowindex1, "strmanage"));
        str+=$('#searshgrid').jqxGrid('getcellvalue', rowindex1, "propertyid");
        str+='<br>';
        str+='Owner:' + $('#searshgrid').jqxGrid('getcellvalue', rowindex1, "owner"); 
        str+='<br>';
        str+='Tel:' + $('#searshgrid').jqxGrid('getcellvalue', rowindex1, "ownertel");
        str+='<br>';
        str+='Mobile:' + $('#searshgrid').jqxGrid('getcellvalue', rowindex1, "ownermobile");
        str+='<br>';
        str+='Email:' + $('#searshgrid').jqxGrid('getcellvalue', rowindex1, "owneremail");
        $('#propertydetail').append(str);   
