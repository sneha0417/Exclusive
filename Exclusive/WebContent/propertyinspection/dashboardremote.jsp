	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$('#btnsavesignature').click(function(){
    			...
    			if(signaturePad.isEmpty()) {
    				...
    				x.open("POST","saveSignature.jsp?formname=BPI&docno="+inspdocno+"&descpt="+attachdesc+"&reftypid="+roomdocno,true); 
			...
			$('#btnattach').click(function(){
				...
				if(furndocno=="0" || furndocno=="" || furndocno==null || furndocno=="undefined" || typeof(furndocno)=="undefined"){
					Swal.fire({
						icon: 'error',
					  	title: 'Warning',
		...
		function getInitData(){
			...
			var x = new XMLHttpRequest();
	  		...
	  		x.open("GET", "getInitData.jsp?insptype="+insptype, true);
	  		x.send();
		}
