...
.card-container{
	...
	.property-category span.green{
		background: #42bc61;
	}
	.property-category span.red{
		background: #EB4343;
	}
	.property-category span label {
	    margin: 0;
	    margin-right: 5px;
	}
</style>
  		...
  		<div class="tab-content">
    		<div id="menu-dashboard" class="tab-pane fade in active">
    			<div class="container-fluid m-t-20">
    				<div class="panel panel-default admin-cover animated fadeInDown fade" id="admin-cover">
				...
				<div class="row m-t-10">
					<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
						<h4><strong>Property Listing</strong></h4>
						<div class="property-list img-rounded" style="border:1px solid #ddd;padding-bottom:20px;padding-left:20px;padding-right:20px;">
							<div class="property-container container-fluid img-rounded">
	  							<div class="property-category">
	  								<span class="green"><label>For Sale</label></span>
	  							</div>
	  							<h4>1312 Richmond</h4>
	    						<p class="text-muted"><i class="fa fa-map-marker"></i>&nbsp;Richmond Place 1312, Charlotte,New York.</p>
	    						<p class="text-right"><small><a href="#propertydata1" data-toggle="collapse">Show more</a></small>
	    						<div class="container-fluid collapse" id="propertydata1" >
    								<ul class="list-group">
									     <li class="list-group-item row">
									     	<span class="col-xs-4">Type</span>
									     	<span class="col-xs-8">Appartment</span>
									     </li>
									     <li class="list-group-item row">
									     	<span class="col-xs-4">Tenant</span>
									     	<span class="col-xs-8">Micheal V Brown</span>
									     </li>
									</ul>
	    						</div>
	    					</div>
	    					<div class="property-container container-fluid img-rounded">
	  							<div class="property-category">
	  								<span class="red"><label>On Contract</label></span>
	  							</div>
	  							<h4>1312 Richmond</h4>
	    						<p class="text-muted"><i class="fa fa-map-marker"></i>&nbsp;Richmond Place 1312, Charlotte,New York</p>
	    					</div>
					...
					<div class="col-xs-12 col-sm-12 col-md-4 col-lg-6">
						<div class="panel panel-default boxshadow1 animated zoomIn">
							<div class="panel-heading">
								<strong>Contract Expiry - Monthwise</strong>
							</div>
    	...
    	$(document).ready(function(){
			...
			$('#btnacstmt').click(function(){
				...
				if(gridrows.length>0){
					var win= window.open("<%=contextPath%>/com/operations/commtransactions/travelinvoice/printAgeingOutstandingsStatement?&acno="+$('#clientacno').val()+"&atype=AR&level1from=0&level1to=30&level2from=31&level2to=60&level3from=61&level3to=90&level4from=91&level4to=120&level5from=121&branch=a&uptoDate="+$('#todate').val()+"&email=Nil&print=1","_blank","top=150,left=250,Width=1020,Height=500,location=no,scrollbars=no,toolbar=yes");
	        		win.focus();
				}
			});
